...
namespace FLightApplication.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserName,FlightId,SeatId,TicketId,Id")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("UserName,FlightId,SeatId,TicketId,Id")] Booking booking)
        {
            if (id != booking.Id)
            {
                return NotFound();
